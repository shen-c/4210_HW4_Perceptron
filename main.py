...
# AUTHOR: Cong Shen
# FILENAME: main.py
# SPECIFICATION: Tests the accuracy of single and multi-layer perceptron classifiers
...
for w in n: #iterates over n
    for b in r: #iterates over r
        for a in range(2): #iterates over the algorithms
            ...
            if a == 0:
                if tempAccuracy > pAccuracy:
                    pAccuracy = (tempAccuracy)
                    print("Highest Perceptron accuracy so far: ", pAccuracy, ", Parameters: ",
                          "learning rate =", w,
                          ", shuffle = ", b)
            else:
                if tempAccuracy > mAccuracy:
                    mAccuracy = (tempAccuracy)
                    print("Highest MLP accuracy so far: ", mAccuracy, ", Parameters: ",
                          "learning rate =", w,
                          ", shuffle = ", b)